...
[verso-slides](https://github.com/leanprover/verso-slides), with the shared Lean FRO theme
(custom CSS, logos, title slide, and per-slide header) wired up via `Main.lean`.
