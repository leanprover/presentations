...
- [[./backchain/back_trace.lean][=back_trace.lean=]]: Add tracing to the previous tactic.

- [[./backchain/back_inplace.lean][=back_inplace.lean=]]: The same example implemeted
...
- =smt_goal= contains the state of the SMT solver for a particular goal.
